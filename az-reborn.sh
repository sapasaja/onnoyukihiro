...
read -p "Pilih Salah Satu Azure VM size (pilih angkanya lalu enter):" ans
case $ans in
...
read -p "Pilih Salah Satu Windows VM (pilih angkanya lalu enter):" ans
case $ans in
    1  )  echo "Windows Server 2022 Datacenter" > abc; echo MicrosoftWindowsServer:WindowsServer:2022-Datacenter:latest > win  ;;
    ...
    ""     )  echo "Kamu Belum Memilih apapun!!!"; sleep 1; goto step2 ;;
    *      )  echo "Tidak ada di pilihan!!!"; sleep 1 ; goto step2 ;;
esac
